...
if ( true === $results ) { // Move on to next step.
	...
	echo '<p style="text-align: center;"><a href="http://ithemes.com/tutorial-create-database-in-cpanel/">Click here for instructions on manual ZIP extraction as a work-around.</a></p>';
	echo '</div><!-- /wrap -->';
}
