	...
	pb_backupbuddy::$ui->start_tab( 'overview' );
		...
		*/
		...
		<div style="float: left;">
			<a href="<?php echo pb_backupbuddy::page_url(); ?>&cleanup_now=true" class="button secondary-button"><?php _e('Cleanup Temporary Files Now', 'it-l10n-backupbuddy' );?>*</a>
			&nbsp;
		...
		<span class="description">* Temporary files are automatically cleaned up on a regularly scheduled basis. The button above allows you to force all cleanup to occur right now.</span>
